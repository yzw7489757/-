{
	...
	body: {
		...
		sms:"SMS:",
		SMSContent:"To change your SMS contact information, select the Contacts Tab and edit the Merchant Default Contact.",
		...
		MessagingTip3:" will be allowed to respond to an Amazon buyer’s message.",
		phone:"Phone Number:",
		...
		emailContent2:"The email address of the merchant default contact is configured to the primary account holder login email address. The email address above is your login email address, and you can update your login details here.",
	     RatePage:"Click here to rate this page",
	     Submissions:"",
	     ReceiveViaEMAIL:"Choose which notifications to receive via EMAIL:"
