{
  ...
  body: {
    ...
    DealCheckBox:"I consent to provide electronic signature for the information provided as per IRS Form W-8BEN",
    DealTip:"If you provide an electronic signature, you will be able to submit your tax information immediately.",
    DealTitle:"Under penalties of perjury, I declare that I have examined the information on this form and to the best of my knowledge and belief it is true, correct, and complete. I further certify under penalties of perjury that:",
    DealEntry1:"I am the individual that is the beneficial owner (or am authorized to sign for the individual that is the beneficial owner) of all the income to which this form relates or am using this form to document myself as an individual that is an owner or account holder of a foreign financial institution,",
    DealEntry2:"The person named on line 1 of this form is not a U.S. person,",
    DealEntry3:"The income to which this form relates is: (a) not effectively connected with the conduct of a trade or business in the United States, (b) effectively connected but is not subject to tax under an applicable income tax treaty, or (c) the partner's share of a partnership's effectively connected income,",
    DealEntry4:"The person named on line 1 of this form is a resident of the treaty country listed on line 9 of the form (if any) within the meaning of the income tax treaty between the United States and that country,",
    DealEntry5:"For broker transactions or barter exchanges, the beneficial owner is an exempt foreign person as defined in the instructions, and",
    DealEntry6:"I agree that I will submit a new form within 30 days if any certification made on this form becomes incorrect.",
    DealEntryEnd:"The Internal Revenue Service does not require your consent to any provisions of this document other than the certifications required to establish your status as a non-U.S. individual and, if applicable, obtain a reduced rate of withholding.",
    DealSign:"Signature (Type your full name)",
    DealSignTip:"By typing my name on the given date, I acknowledge I am signing the tax documentation under penalties of perjury.",
    DealDate:"Date",
    Deal2Tip:"Above is preview of your tax form based on the information you have provided. Please review and submit the form, or make changes if needed.",
    DealButtonChange:"Make Changes",
    DealButtonSubmit:"Submit Form",
     DealButtonSave:"Save and Preview"
