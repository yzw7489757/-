{
  ...
  body: {
    ...
    Cover:"Amazon.com.mx Overrides",
    ButtonChangeAddress:"Set the address",
    DeleteTheseOverrides:"Remove these overrides",
    OverridesTips:"All returns will be sent to this address unless other addresses are specified in the marketplace exceptions below",
    ExceptionRule:"Default Return Address",
    RuleTips:"All returns will be sent to this address unless other addresses are specified in the marketplace exceptions below",
    alertTips:"Return address is required for setting return settings. Please set return address by going to return address settings.",
    alertTitle:"Success",
    alertContent:"Successful submission of enterprise address",
