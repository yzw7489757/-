    ...
    function distribution(e,popover_down){
        if(e.hasClass('splitdropdown')){
            ...
            var html = '<li>'+
                        ...
                        '</li>'+
                        '<li>'+
                            '<a href="manage_inventory_fulfilled_merchant.html" class="drop_link">'+
                                '转换为"卖家自行配送"'+
                            '</a>'+
                        '</li>'+
                        '<li>'+
                            '<a href="manage_inventory_restocking.html?goodsID='+goodsID+'&sku_id='+skuId+'"" class="drop_link">'+
                                '发/货'+
                            '</a>'+
                        '</li>'+
                        '<li>'+
                            '<a href="manage_inventory_replenishment_alerts.html" class="drop_link">'+
                                '设置补货提醒'+
                            '</a>'+
                        '</li>'+
                        '<li>'+
                            '<a href="manage_inventory_remove_order.html" class="drop_link">'+
                                '创建移除订单'+
                            '</a>'+
                        '</li>'+
                        '<li>'+
    ...
    function manage_render(data){
        ...
        $.each(data.data, function(i, val) {
             ...
             list_html += '<tr>'+
                             ...
                             '<td id="dGFvd3cx-title_'+i+'" data-column="title" class="mt-header-left">'+
                                 ...
                                 '</div>'+
                                 '<div class="mt-table-header-detail">'+val.sku_id+'</div>'+
                             '</td>'+
                            ...
                            '</td>'+
                             ...
                             '<td id="dGFvd3cx-action_'+i+'" data-column="action" class="mt-header-center">'+
                                 '<div class="mt-button clear_both">'+
                                     ...
                                     '<button class="secondaryAUIButton splitdropdown fl drop_ul editDrop" mode="'+val.shipping_mode+'" goodsId="'+val.goods_id+'" sku="'+val.sku_id+'">'+
        ...
        manage_list.on('click', '.edit', function() {
            if($(this).attr('follow') == 0){
                ...
                inputctr.public.judgeBegaintask('1211');
        ...
        // manage_list.on('click', '.editDrop', function() {
        //     if(window.sessionStorage){
        //         sessionStorage.setItem('skuID',$(this).attr('sku'));
        //         sessionStorage.setItem('goodsID',$(this).attr('goods_id'))
        //     }
        // });
        select();
