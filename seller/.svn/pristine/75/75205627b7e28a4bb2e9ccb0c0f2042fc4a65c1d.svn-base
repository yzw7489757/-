var ask_inform_html = '<div class="ask_inform_box">'+
                          ...
                          '</div>'+
                      '</div>'
function popover_click(ask,ask_inform_box,content){
    ...
    ask.click(function() {
       ...
       answer_show.children('.ask_question').text(content.quesition)
       answer_show.children('.answer_con').text(content.content)
